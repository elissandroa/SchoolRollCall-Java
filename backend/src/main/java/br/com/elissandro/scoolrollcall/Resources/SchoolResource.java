...
public class SchoolResource {
	...
	@GetMapping
	public ResponseEntity<Page<SchoolDTO>> findAll(Pageable pageable) {
		Page<SchoolDTO> list = service.findAllPaged(pageable);
	...
	@PostMapping
	public ResponseEntity<SchoolDTO> insert(@Valid @RequestBody SchoolDTO dto) {
