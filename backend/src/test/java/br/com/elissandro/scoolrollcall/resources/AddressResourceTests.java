...
public class AddressResourceTests {
	...
	public void findAllShouldReturnPage() throws Exception {
		ResultActions result = mockMvc.perform(get("/Addresss")
	...
	public void findByIdShouldReturnAddressWhenIdExists() throws Exception {
		ResultActions result = mockMvc.perform(get("/Addresss/{id}", existingId)
				.accept(MediaType.APPLICATION_JSON));
	...
	public void findByIdShouldReturnNotFoundWhenIdDoesNotExist() throws Exception {
		ResultActions result = mockMvc.perform(get("/Addresss/{nonExistingId}", nonExistingId)
				.accept(MediaType.APPLICATION_JSON));
	...
	public void insertShouldReturnAddressDTOCreated() throws Exception {
		ResultActions result = mockMvc.perform(post("/Addresss")
	...
	public void updateShouldReturnAddressDTOWhenIdExists() throws Exception {
		ResultActions result = mockMvc.perform(put("/Addresss/{id}", existingId)
				.content(objectMapper.writeValueAsString(addressDTO))
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON));
	...
	public void updateShouldReturnNotFoundWhenIdDoesNotExist() throws Exception {
		ResultActions result = mockMvc.perform(put("/Addresss/{id}", nonExistingId)
				.content(objectMapper.writeValueAsString(addressDTO))
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON));
	...
	public void deleteShouldReturnNoContentWhenIdExists() throws Exception {
		ResultActions result = mockMvc.perform(delete("/Addresss/{id}", existingId)
				.accept(MediaType.APPLICATION_JSON));
	...
	public void deleteShouldReturnNotFoundWhenIdDoesNotExist() throws Exception {
		ResultActions result = mockMvc.perform(delete("/Addresss/{id}", nonExistingId)
				.accept(MediaType.APPLICATION_JSON));
	...
	public void deleteShouldReturnBadRequestWhenIdIsDependent() throws Exception {
		ResultActions result = mockMvc.perform(delete("/Addresss/{id}", dependentId)
				.accept(MediaType.APPLICATION_JSON));
